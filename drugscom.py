# -*- coding: utf-8 -*-
"""
Created on Sun Mar 26 22:33:42 2023
...
st.header("Patients Condition Classification Using Drug Reviews")
st.title("![Alt Text](https://i.imgur.com/diKnsyF.jpg)")
...
svm_deploy = load(open("D:/arya_projects/svm_deploy.pkl", "rb"))
tf_idf_deploy = load(open("D:/arya_projects/tf_idf_deploy.pkl", "rb"))

#Initializing necessary functions and stop words
lemmatizer = WordNetLemmatizer()
w_tokenizer=WhitespaceTokenizer()
stop_words =pd.read_csv('drugsCom_raw.tsv',sep = '\t')
